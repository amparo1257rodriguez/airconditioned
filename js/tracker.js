...
function make_stats_now(acc,path) {         // make statistics
    ...
    return '<A ' + 'HREF="' + path +'?NAVG=Linker&username='+acc+'" target="_top"><IMG' +
     ' SRC="' + path + '?NAVG=Tracker&'+ args + 
     '" ALT="Click here for more detailed statistical reports about this web page!"'+
     ' BORDER=0></A>';
};
...
/*
     FILE ARCHIVED ON 23:08:46 Aug 10, 2004 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 14:15:28 Apr 14, 2025.
...
playback timings (ms):
  ...
  esindex: 0.013
  cdx.remote: 19.134
  LoadShardBlock: 541.079 (3)
  PetaboxLoader3.datanode: 119.288 (4)
  PetaboxLoader3.resolve: 668.893 (2)
  load_resource: 256.719
*/